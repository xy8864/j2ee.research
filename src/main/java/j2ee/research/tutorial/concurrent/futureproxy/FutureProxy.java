package j2ee.research.tutorial.concurrent.futureproxy;
...
public abstract class FutureProxy<T> {
	...
	public final T getProxyInstance() {
		...
		if(interfaceClass == null || !interfaceClass.isInterface()){ throw new IllegalStateException(); }
		...
		return (T)Proxy.newProxyInstance(interfaceClass.getClassLoader(),new Class<?>[]{ interfaceClass },
				new InvocationHandlerImpl<T>(future));
	}
}
